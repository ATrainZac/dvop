...
async function convertCoverage() {
    ...
    const thresholds = {
        lines: 80, // Minimum 90% of lines must be covered
        statements: 80, // Minimum 90% of statements must be covered
        functions: 80, // Minimum 90% of functions must be covered
        branches: 80 // Minimum 90% of branches must be covered
    };
